...
with st.sidebar:
    ...
    num_hipotecas = st.number_input('Numero de hipotecas', 0, 30)
...
#MAIN
st.title('RISK CREDIT SCORE ANALYZER')
...
if st.sidebar.button('CALCULAR RIESGO'):
    ...
    kpi_lgd = int(EL.lg * 100)
    kpi_el = int(EL.principal * EL.pd * EL.ead * EL.lg)


    #Color de Velocimetros

    color_pd = 'green'
    if (kpi_pd > 30) & (kpi_pd <= 60):
        color_pd = 'yellow'
    elif kpi_pd > 60:
        color_pd = 'red'
    else:
